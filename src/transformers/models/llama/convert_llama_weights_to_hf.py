...
def write_model(model_path, input_base_path, model_size):
    ...
    for layer_i in range(params["n_layers"]):
        ...
        state_dict = {
            f"model.decoder.layers.{layer_i}.self_attn.q_proj.weight": checkpoint[f"layers.{layer_i}.attention.wq.weight"],
            ...
            f"model.decoder.layers.{layer_i}.attention_norm.weight": checkpoint[f"layers.{layer_i}.attention_norm.weight"],
